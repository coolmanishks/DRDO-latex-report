...
\lhead{}\chead{}\rhead{Project Report \textbar DRDO}
...
\begin{figure}[H]
\centering
  \includegraphics[width=0.8\linewidth]{RadarBlockDiagram.png}
...
\begin{figure}[H]
   \includegraphics[width=\linewidth]{psploggerblockdiagram.jpg}
...
\begin{figure}[H]
\centering
  \includegraphics[width=0.75\linewidth]{pspmergerblockdiagram.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{pspmergerflow.jpg}
...
\includegraphics[width=\linewidth]{azimuth(20000,20100).jpg}
  ...
  \noindent \textbf{Definition : }\\
   ...
   \begin{figure}[H]
   \centering
 \includegraphics[width=0.7\linewidth]{elevation.jpg}
